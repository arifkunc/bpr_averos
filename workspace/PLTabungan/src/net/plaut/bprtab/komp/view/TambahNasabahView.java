...
public class TambahNasabahView extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TambahNasabahView frame = new TambahNasabahView();
	...
	public TambahNasabahView() {
		...
		panel.setBounds(10, 335, 414, 37);
		getContentPane().add(panel);
		
				JButton btnSimpan = new JButton("Simpan");
				btnSimpan.setIcon(new ImageIcon(TambahNasabahView.class.getResource("/net/plaut/bprtab/resources/Simpan.png")));
				btnSimpan.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						btnReset.setIcon(new ImageIcon(TambahNasabahView.class.getResource("/net/plaut/bprtab/resources/Reset.png")));
						panel.add(btnReset);
				...
				btnSimpan.setFont(new Font("Arial", Font.BOLD, 15));
						...
						btnBatal.setIcon(new ImageIcon(TambahNasabahView.class.getResource("/net/plaut/bprtab/resources/Batal.png")));
						panel.add(btnBatal);
						btnBatal.setFont(new Font("Arial", Font.BOLD, 15));
								
								Panel panel_1 = new Panel();
								panel_1.setBackground(new Color(255, 250, 240));
								panel_1.setBounds(10, 11, 414, 318);
								...
								panel_1.add(label_7);
										...
										tfNomorID.setBounds(142, 8, 192, 25);
										...
										tfNomorID.setColumns(10);
												...
												taAlamat.setForeground(new Color(0, 0, 0));
