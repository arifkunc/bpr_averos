...
public class SetorTabunganView extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SetorTabunganView frame = new SetorTabunganView();
	 ...
	 * Create the frame.
	 */
	public SetorTabunganView() {
		getContentPane().setBackground(new Color(255, 250, 205));
		setFrameIcon(new ImageIcon(SetorTabunganView.class.getResource("/net/plaut/bprtab/resources/Setor.png")));
		getContentPane().setFont(new Font("Arial", Font.PLAIN, 15));
		setTitle("Setor Tabungan");
		...
		btnCari.setIcon(new ImageIcon(SetorTabunganView.class.getResource("/net/plaut/bprtab/resources/Cari.png")));
		...
		btnCetak.setIcon(new ImageIcon(SetorTabunganView.class.getResource("/net/plaut/bprtab/resources/Cetak.png")));
		...
		btnSimpan.setIcon(new ImageIcon(SetorTabunganView.class.getResource("/net/plaut/bprtab/resources/Simpan.png")));
		panel_2.add(btnSimpan);
		btnSimpan.setFont(new Font("Arial", Font.BOLD, 15));
		
		JButton btnBatal = new JButton("Batal");
		btnBatal.setIcon(new ImageIcon(SetorTabunganView.class.getResource("/net/plaut/bprtab/resources/Batal.png")));
