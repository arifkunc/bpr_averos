...
public class BatalSetorTabunganView extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BatalSetorTabunganView frame = new BatalSetorTabunganView();
	 ...
	 * Create the frame.
	 */
	public BatalSetorTabunganView() {
		getContentPane().setBackground(new Color(255, 250, 205));
		setFrameIcon(new ImageIcon(BatalSetorTabunganView.class.getResource("/net/plaut/bprtab/resources/BatalSetor.png")));
		getContentPane().setFont(new Font("Arial", Font.PLAIN, 15));
		setTitle("Batal Setor Tabungan");
		...
		btnCari.setIcon(new ImageIcon(BatalSetorTabunganView.class.getResource("/net/plaut/bprtab/resources/Cari.png")));
		...
		btnSimpan.setIcon(new ImageIcon(BatalSetorTabunganView.class.getResource("/net/plaut/bprtab/resources/Simpan.png")));
		panel_2.add(btnSimpan);
		btnSimpan.setFont(new Font("Arial", Font.BOLD, 15));
		
		JButton btnBatal = new JButton("Kembali");
		btnBatal.setIcon(new ImageIcon(BatalSetorTabunganView.class.getResource("/net/plaut/bprtab/resources/Batal.png")));
