...
public class TarikTabunganView extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TarikTabunganView frame = new TarikTabunganView();
	 ...
	 * Create the frame.
	 */
	public TarikTabunganView() {
		getContentPane().setBackground(new Color(255, 250, 205));
		setFrameIcon(new ImageIcon(TarikTabunganView.class.getResource("/net/plaut/bprtab/resources/Tarik.png")));
		getContentPane().setFont(new Font("Arial", Font.PLAIN, 15));
		setTitle("Tarik Tabungan");
		...
		btnCari.setIcon(new ImageIcon(TarikTabunganView.class.getResource("/net/plaut/bprtab/resources/Cari.png")));
		...
		btnCetak.setIcon(new ImageIcon(TarikTabunganView.class.getResource("/net/plaut/bprtab/resources/Cetak.png")));
		panel_2.add(btnCetak);
		...
		btnSimpan.setIcon(new ImageIcon(TarikTabunganView.class.getResource("/net/plaut/bprtab/resources/Simpan.png")));
		panel_2.add(btnSimpan);
		btnSimpan.setFont(new Font("Arial", Font.BOLD, 15));
		
		JButton btnBatal = new JButton("Batal");
		btnBatal.setIcon(new ImageIcon(TarikTabunganView.class.getResource("/net/plaut/bprtab/resources/Batal.png")));
