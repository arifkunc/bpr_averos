...
public class UbahNasabahView extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UbahNasabahView frame = new UbahNasabahView();
	 ...
	 * Create the frame.
	 */
	public UbahNasabahView() {
		setFrameIcon(new ImageIcon(UbahNasabahView.class.getResource("/net/plaut/bprtab/resources/EditNasabah.png")));
		...
		getContentPane().add(panel);
				...
				btnSimpan.setIcon(new ImageIcon(UbahNasabahView.class.getResource("/net/plaut/bprtab/resources/Simpan.png")));
				btnSimpan.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						btnReset.setIcon(new ImageIcon(UbahNasabahView.class.getResource("/net/plaut/bprtab/resources/Reset.png")));
						panel.add(btnReset);
				...
				btnSimpan.setFont(new Font("Arial", Font.BOLD, 15));
						...
						btnBatal.setIcon(new ImageIcon(UbahNasabahView.class.getResource("/net/plaut/bprtab/resources/Batal.png")));
						panel.add(btnBatal);
																		...
																		taKeterangan.setFont(new Font("Arial", Font.BOLD, 15));
																				...
																				rdbtnLakilaki.setFont(new Font("Arial", Font.PLAIN, 15));
																						...
																						tfNama.setColumns(10);
																								...
																								addKelas.setBounds(244, 72, 40, 25);
																								panel_1.add(addKelas);
																										...
																										cbKelas.setFont(new Font("Arial", Font.BOLD, 15));
																												...
																												button.setIcon(new ImageIcon(UbahNasabahView.class.getResource("/net/plaut/bprtab/resources/Cari.png")));
